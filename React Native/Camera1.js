  ...
  render(){
    ...
    return(
      ...
      <View style={{flex:1,backgroundColor:'#313131',justifyContent:'center',alignItems:'center'}}>
        <View style={{flex:0.5,justifyContent:'center',alignItems:'center',height:height*0.1}}>
            <Text style={{fontFamily:'Rajdhani-Regular',fontSize:35,color:'yellow',textAlign:'center'}}>Cam1</Text>
        </View>

        <ImageBackground style={{width: width, height: height*0.3}} source={require('./Photo/cam1.png')} >
          <Image
